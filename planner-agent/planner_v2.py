...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:3000", 
        "http://127.0.0.1:3000", 
        "http://frontend-dashboard:3000",
        "",
        "*"  # Allow all origins for SSE connections
    ],  # Your frontend URL
...
async def detect_intent(user_input: UserInput):
    ...
    if Intent == "other":
        ...
        return handle_pre_authorization(Intent, patient_id, payer, user_input.user_id, request_id) #, parsed.is_valid_payer)
